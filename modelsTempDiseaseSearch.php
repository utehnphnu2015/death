...
use app\models\TempDisease;

/**
 * modelsTempDiseaseSearch represents the model behind the search form about `app\models\TempDisease`.
 */
class modelsTempDiseaseSearch extends TempDisease
{
    /**
     * @inheritdoc
     */
